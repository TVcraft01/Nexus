...
class NexusMessage {
  ...
  static const serialMsg =
      'serial.msg'; // peer → host: forward a payload to a cable node
  static const serialUp =
      'serial.up'; // host → peer: a payload from a cable node
  static const agentAction =
      'agent.action'; // peer → device: run an approved action
  static const agentResult =
      'agent.result'; // device → peer: the action's outcome
  static const agentLearned =
  ...
  static const agentDefault =
      'agent.default'; // device → peers: a "which …?" answer just remembered
  static const agentProfile =
      'agent.profile'; // device → peers: the user/assistant were renamed
  static const brainAsk =
      'brain.ask'; // peer → device: answer a conversation question for me
  static const brainAnswer =
      'brain.answer'; // device → peer: the brain's reply to a brain.ask
